...
This shows all posts for #rstats, #dataBS, and #dataRescue (as example keywords) that contain the text terms got, helped, scraped, mirrored, downloaded, copied (as examples of relevent terms in a time sensitive emergency).
...
patterns <- c("got", "helped", "scraped", "mirrored", 
              "downloaded", "copied")
